...
class BadgesManagerTest(unittest.IsolatedAsyncioTestCase):
    ...
    def test_start_game_starts_from_level_1(self):
        ...
        self.assertEqual(badges_manager.serialize(), '{"badges_state": {"CatBadgeCounter": "pending_happy,57600", '
                                                     ...
                                                     '"board": [{"badge": "f0", "is_active": true, "is_last_modified": true}, {"badge": "s0", "is_active": null}, '
                                                     '{"badge": "c0", "is_active": null}], "level": 0, "last_badge": "f0"}')
    ...
    def test_grumpy_cat_gets_in(self):
        badges_manager = BadgesManager('{"badges_state": {"CatBadgeCounter": "pending_happy,57600", "TimeBadgeCounter": "86400", "StarBadgeCounter": "0", '
                                       '"FeatherBadgeCounter": "86400"}, "board": [{"badge": "f0", "is_active": true, "is_last_modified": true}, {"badge": "s0", "is_active": null}, {"badge": "c0", "is_active": null}], "level": 0, "last_badge": "f0"}')
        ...
        self.assertEqual(badges_manager.serialize(), '{"badges_state": {"CatBadgeCounter": "pending_happy,118600", "TimeBadgeCounter": "86400", '
                                                     '"StarBadgeCounter": "0", "FeatherBadgeCounter": "86400"}, '
                                                     '"board": [{"badge": "f0", "is_active": true}, {"badge": "s0", "is_active": null}, '
                                                     '{"badge": "c0", "is_active": true, "is_last_modified": true}], "level": 0, "last_badge": "c0"}')
    ...
    def test_senior_badge_overwrite(self):
        board_s0 = '[{"badge": "f0", "is_active": true}, {"badge": "s0", "is_active": null}, {"badge": "c0", "is_active": null}]'
        board_s2 = '[{"badge": "f0", "is_active": true}, {"badge": "s2", "is_active": null}, {"badge": "c0", "is_active": null}]'
        ...
        self.assertEqual(badges_manager_s2.get_board(), [{'badge': 'f0', 'is_active': True},
                                                                                {'badge': 's2', 'is_active': True, 'is_last_modified': True},
                                                                                {'badge': 'c0', 'is_active': None}])
        ...
        self.assertEqual(badges_manager_s0.get_board(), [{'badge': 'f0', 'is_active': True},
                                                                                {'badge': 's0', 'is_active': True, 'is_last_modified': True},
                                                                                {'badge': 'c0', 'is_active': None}])
    ...
    def test_level_up(self):
        badges_manager = BadgesManager('{"badges_state": {"CatBadgeCounter": "pending_happy,57600", "TimeBadgeCounter": "86400", "StarBadgeCounter": "0", '
                                       '"FeatherBadgeCounter": "86400"}, "board": '
                                       '[{"badge": "f0", "is_active": true}, {"badge": "s0", "is_active": true}, {"badge": "c0", "is_active": null}], "level": 0, "last_badge": "f0"}')
