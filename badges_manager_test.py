...
class BadgesManagerTest(unittest.IsolatedAsyncioTestCase):
    ...
    def test_start_game_starts_from_level_1(self):
        ...
        self.assertEqual(badges_manager.serialize(), '{"badges_state": {"CatBadgeCounter": "pending_happy,57600", "TimeBadgeCounter": "86400", "StarBadgeCounter": "0", "FeatherBadgeCounter": "86400"}, "board": [{"badge": "f0", "is_active": null, "is_target": true}, {"badge": "s0", "is_active": null}, {"badge": "c0", "is_active": null}], "level": 0, "last_badge": "f0"}')


    def test_grumpy_cat_gets_in(self):
        badges_manager = BadgesManager('{"badges_state": {"CatBadgeCounter": "pending_happy,57600", "TimeBadgeCounter": "86400", "StarBadgeCounter": "0", "FeatherBadgeCounter": "86400"}, "board": [{"badge": "f0", "is_active": null, "is_target": true}, {"badge": "s0", "is_active": null}, {"badge": "c0", "is_active": null}], "level": 0, "last_badge": "f0"}')
        ...
        self.assertEqual(badges_manager.is_level_completed(), False)
        self.assertEqual(badges_manager.serialize(), '{"badges_state": {"CatBadgeCounter": "pending_happy,118600", "TimeBadgeCounter": "86400", "StarBadgeCounter": "0", "FeatherBadgeCounter": "86400"}, "board": [{"badge": "f0", "is_active": true}, {"badge": "s0", "is_active": null}, {"badge": "c0", "is_active": null, "is_target": true}], "level": 0, "last_badge": "c0"}')

    def test_kicking_out_grumpy_cat(self):
        badges_manager = BadgesManager('{"badges_state": {"CatBadgeCounter": "pending_happy,118600", "TimeBadgeCounter": "86400", "StarBadgeCounter": "0", "FeatherBadgeCounter": "86400"}, "board": [{"badge": "f0", "is_active": true}, {"badge": "s0", "is_active": null}, {"badge": "c0", "is_active": null, "is_target": true}], "level": 0, "last_badge": "c0"}')
    ...
    def test_senior_badge_overwrite(self):
        ...
        badges_manager_s0 = BadgesManager('{"badges_state": {"CatBadgeCounter": "pending_happy,57600", "TimeBadgeCounter": "86400", "StarBadgeCounter": "8", "FeatherBadgeCounter": "86400"}, "board": ' + board_s0 + ', "level": 0, "last_badge": "f0"}')
        badges_manager_s2 = BadgesManager('{"badges_state": {"CatBadgeCounter": "pending_happy,57600", "TimeBadgeCounter": "86400", "StarBadgeCounter": "8", "FeatherBadgeCounter": "86400"}, "board": ' + board_s2 + ', "level": 0, "last_badge": "f0"}')

        badge = badges_manager_s2.on_review(2000, 2)
        self.assertEqual(badge, "s2")
        self.assertEqual(badges_manager_s2.get_last_badge(), "s2")
        self.assertEqual(badges_manager_s2.get_board(), [{'badge': 'f0', 'is_active': True},
        ...
        self.assertEqual(badges_manager_s0.get_board(), [{'badge': 'f0', 'is_active': True},
    ...
    def test_level_up(self):
        badges_manager = BadgesManager('{"badges_state": {"CatBadgeCounter": "pending_happy,57600", "TimeBadgeCounter": "86400", "StarBadgeCounter": "0", "FeatherBadgeCounter": "86400"}, "board": [{"badge": "f0", "is_active": true}, {"badge": "s0", "is_active": true}, {"badge": "c0", "is_active": null}], "level": 0, "last_badge": "f0"}')
        ...
        self.assertEqual(badges_manager.get_board(), [{'badge': 's1'}, {'badge': 't0'}, {'badge': 'c0'}, {'badge': 'c0'}])